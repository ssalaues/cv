...
% cover 
% As some one who is passionate about DeFi coupled with extensive experience building distributed 
% storage, ground up infra design and scaling solutions, I do not shy away from complexity. I would 
% be an excellent addition to the team at OpenBlock exploring new solutions to get ahead of ever 
% growing problems. 
...
\begin{minipage}[t]{0.45\textwidth} % 45% of the page width for name
	...
	% \colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{seslly}}}}} % First name
...
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the second row of icons
	...
	% \icon{Twitter}{12}{\href{https://twitter.com/@SalimSalaues}{@SalimSalaues}}\\
\end{minipage}
